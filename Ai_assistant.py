...
class AI_Assistant:
    def __init__(self):
        aai.settings.api_key = "1f414e80ee924a46b402891f470b29c9"
...
# Ottieni l'indice del dispositivo di input predefinito
default_input_index = p.get_default_input_device_info()['index']
default_input_name = p.get_default_input_device_info()['name']

print(f"Indice del microfono predefinito: {default_input_index}")
print(f"Nome del microfono predefinito: {default_input_name}")

# Termina l'istanza di PyAudio
p.terminate()
